...
from empirestaterunup.analyze import SUMMARY_METRICS, get_5_number, count_by_age, count_by_gender, \
    dt_to_sorted_dict, get_outliers, age_bins, time_bins, get_country_counts, better_than_median, FastestFilters, \
    find_fastest
...
class FiveNumberApp(App):
    ...
    def on_mount(self) -> None:
        ...
        """
        median_run_time = better_than_median(FiveNumberApp.DF)
        ...
        summary_table.tooltip = f"Median running time: {median_run_time}"
        ...
        age_table.tooltip = f"Median running time: {median_run_time}"
        ...
        gender_table.tooltip = f"Median running time: {median_run_time}"
        ...
        country_counts_table.tooltip = f"Median running time: {median_run_time}"
